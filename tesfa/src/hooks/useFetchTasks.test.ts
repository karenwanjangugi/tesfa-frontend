...
describe('useTasks', () => {
  ...
  const mockApiTasks = [
    { id: 1, title: 'Assigned Task', description: 'Already assigned', status: 'pending' },
    { id: 2, title: 'Available Task', description: 'Not assigned yet', status: 'pending' },
    { id: 3, title: 'Also Assigned', description: 'Already taken', status: 'pending' },
  ];
  ...
  it('fetches and filters unassigned tasks successfully', async () => {
    ...
    expect(fetchCall[0]).toBe('https://api.example.com/tasks');
